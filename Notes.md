...
- Sequence index
- Data length
- Data: 0 or more data bytes, max 250
- Checksum: Total sum of all bytes included == 0xFF; so 0xFF-total with wrap

## Startup

### SYNC {BE,50,00,03,00,00,01,ED} [Rx] - in normal boot mode
### SYNC {BE,50,00,03,55,01,01,XX} [Rx] - in secure boot mode

Version: 0x0100

In normal boot: data[0] == 0x00, version 0x0100
In secure boot: data[0] == 0x55, version 0x0101 (see @ BOOTROM:000018C0)

### SYNC Resp {BE,50,00,01,01,EF} [Tx] - in normal boot mode
### SYNC Resp {BE,50,00,01,56,XX} [Tx] - in secure boot mode


### SYNC Confirm {BE,50,00,03,02,00,01,EB} [Rx] - in normal boot mode
### SYNC Confirm {BE,50,00,03,57,00,01,XX} [Rx] - in secure boot mode
